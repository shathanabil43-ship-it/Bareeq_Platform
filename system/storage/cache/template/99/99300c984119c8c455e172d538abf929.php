...
class __TwigTemplate_af6b31c1486b9c73eb819934f92fa749 extends Template
{
...
";
    ...
    {
        return array (  196 => 38,  192 => 37,  186 => 33,  180 => 30,  177 => 29,  174 => 28,  157 => 25,  153 => 24,  149 => 23,  145 => 22,  141 => 21,  137 => 20,  133 => 19,  126 => 18,  121 => 17,  119 => 16,  112 => 12,  100 => 11,  88 => 10,  76 => 9,  64 => 8,  52 => 7,  42 => 1,);
    }
        ...
        {% if users %}
          {% for user in users %}
            <tr{% if not user.status %} class=\"table-disabled\"{% endif %}>
              ...
              <td class=\"text-end text-nowrap\"><a href=\"{{ user.edit }}\" data-bs-toggle=\"tooltip\" title=\"{{ button_edit }}\" class=\"{% if not user.status %}btn btn-secondary{% else %}btn btn-primary{% endif %}\"><i class=\"fa-solid fa-pencil\"></i></a></td>
            </tr>
          {% endfor %}
        {% else %}
          <tr>
...
", "admin/view/template/user/user_list.twig", "C:\\xampp\\htdocs\\bareeq_platform\\admin\\view\\template\\user\\user_list.twig");
    }
}
