...
class __TwigTemplate_ded4630c97ecf3ae2e13f85e522ae746 extends Template
{
...
";
    ...
    {
        return array (  109 => 29,  95 => 18,  91 => 17,  84 => 12,  73 => 10,  69 => 9,  64 => 7,  56 => 6,  50 => 5,  42 => 1,);
    }
  ...
  <div class=\"page-header\">
    <div class=\"container-fluid\">
      <div class=\"float-end\"><a href=\"{{ add }}\" data-bs-toggle=\"tooltip\" title=\"{{ button_add }}\" class=\"btn btn-primary\"><i class=\"fa-solid fa-plus\"></i></a>
        <button type=\"submit\" form=\"form-download\" formaction=\"{{ delete }}\" data-bs-toggle=\"tooltip\" title=\"{{ button_delete }}\" onclick=\"return confirm('{{ text_confirm }}');\" class=\"btn btn-danger\"><i class=\"fa-regular fa-trash-can\"></i></button></div>
      <h1>{{ heading_title }}</h1>
      <ol class=\"breadcrumb\">
...
//--></script>
{{ footer }}", "admin/view/template/catalog/download.twig", "C:\\xampp\\htdocs\\bareeq_platform\\admin\\view\\template\\catalog\\download.twig");
    }
}
