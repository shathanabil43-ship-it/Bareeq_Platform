...
class __TwigTemplate_b867e7245608d7de9f62fb8b9b01952a extends Template
{
      ...
      <tbody>
        ...
        if (($context["seo_urls"] ?? null)) {
          ...
          ";
            ...
            unset($context['_seq'], $context['_key'], $context['seo_url'], $context['_parent']);
  ...
  <div class=\"row\">
    ...
    {
        return new Source("<form id=\"form-seo-url\" method=\"post\" data-oc-toggle=\"ajax\" data-oc-load=\"{{ action }}\" data-oc-target=\"#list\">
  <div class=\"table-responsive\">
    <table class=\"table table-bordered table-hover\">
      <thead>
        <tr>
...
</form>", "admin/view/template/design/seo_url_list.twig", "C:\\xampp\\htdocs\\bareeq_platform\\admin\\view\\template\\design\\seo_url_list.twig");
    }
}
