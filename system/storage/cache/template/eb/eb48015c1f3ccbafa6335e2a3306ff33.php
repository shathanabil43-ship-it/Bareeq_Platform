...
class __TwigTemplate_60a388e4312dddf943fc619cc8a61330 extends Template
{
    ...
    <div class=\"card\">
      ...
      <div class=\"card-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            ...
            yield "][name]\" value=\"";
            yield (((($_v0 = ($context["filter_description"] ?? null)) && is_array($_v0) || $_v0 instanceof ArrayAccess ? ($_v0[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 27)] ?? null) : null)) ? (CoreExtension::getAttribute($this->env, $this->source, (($_v1 = ($context["filter_description"] ?? null)) && is_array($_v1) || $_v1 instanceof ArrayAccess ? ($_v1[CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 27)] ?? null) : null), "name", [], "any", false, false, false, 27)) : (""));
            yield "\" placeholder=\"";
            yield ($context["entry_name"] ?? null);
            yield "\" id=\"input-name-";
            yield CoreExtension::getAttribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 27);
            ...
            <div class=\"col-sm-10\">
              {% for language in languages %}
                <div class=\"input-group\">
                  ...
                  <input type=\"text\" name=\"filter_description[{{ language.language_id }}][name]\" value=\"{{ filter_description[language.language_id] ? filter_description[language.language_id].name }}\" placeholder=\"{{ entry_name }}\" id=\"input-name-{{ language.language_id }}\" class=\"form-control\" required/>
                </div>
...
{{ footer }}", "admin/view/template/catalog/filter_form.twig", "C:\\xampp\\htdocs\\bareeq_platform\\admin\\view\\template\\catalog\\filter_form.twig");
    }
}
