...
class __TwigTemplate_b96ac773b43e8c43800163ada2a9a7f5 extends Template
{
        ...
        if (($context["themes"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["theme"]) {
              ...
              <td class=\"text-end text-nowrap\"><a href=\"";
                ...
                yield "\" class=\"";
                if ( !CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "status", [], "any", false, false, false, 21)) {
                    yield "btn btn-secondary";
                } else {
                    yield "btn btn-primary";
                }
                yield "\"><i class=\"fa-solid fa-pencil\"></i></a> <button type=\"button\" value=\"";
  ...
  <div class=\"row\">
    ...
    {
        return array (  144 => 34,  140 => 33,  134 => 29,  128 => 26,  125 => 25,  122 => 24,  101 => 21,  97 => 20,  93 => 19,  89 => 18,  85 => 17,  78 => 16,  73 => 15,  71 => 14,  64 => 10,  60 => 9,  56 => 8,  52 => 7,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("<form id=\"form-theme\" method=\"post\" data-oc-toggle=\"ajax\" data-oc-load=\"{{ action }}\" data-oc-target=\"#list\">
  <div class=\"table-responsive\">
    <table class=\"table table-bordered\">
      <thead>
        <tr>
      ...
      <tbody>
        {% if themes %}
          {% for theme in themes %}
            <tr{% if not theme.status %} class=\"table-disabled\"{% endif %}>
...
</form>", "admin/view/template/design/theme_list.twig", "C:\\xampp\\htdocs\\bareeq_platform\\admin\\view\\template\\design\\theme_list.twig");
    }
}
