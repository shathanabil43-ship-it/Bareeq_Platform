...
class __TwigTemplate_fd24111d639343fc2d400a6080dab6d9 extends Template
{
  ...
  <div class=\"row\">
    ...
    {
        return new Source("<form id=\"form-download\" method=\"post\" data-oc-toggle=\"ajax\" data-oc-load=\"{{ action }}\" data-oc-target=\"#list\">
  <div class=\"table-responsive\">
    <table class=\"table table-bordered table-hover\">
      <thead>
        <tr>
          <th class=\"text-center\" style=\"width: 1px;\"><input type=\"checkbox\" onclick=\"\$('input[name*=\\'selected\\']').prop('checked', \$(this).prop('checked'));\" class=\"form-check-input\"/></th>
          <th><a href=\"{{ sort_name }}\"{% if sort == 'dd.name' %} class=\"{{ order|lower }}\"{% endif %}>{{ column_name }}</a></th>
          <th class=\"text-end\"><a href=\"{{ sort_date_added }}\"{% if sort == 'd.date_added' %} class=\"{{ order|lower }}\"{% endif %}>{{ column_date_added }}</a></th>
...
</form>", "admin/view/template/catalog/download_list.twig", "C:\\xampp\\htdocs\\bareeq_platform\\admin\\view\\template\\catalog\\download_list.twig");
    }
}
