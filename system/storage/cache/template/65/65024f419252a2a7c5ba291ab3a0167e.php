...
\t\t\t\t\t\t\t\t\t\t\t<td>";
                // line 44
                yield CoreExtension::getAttribute($this->env, $this->source, $context["reward"], "date_added", [], "any", false, false, false, 44);
                yield "</td>
\t\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 46
                if (CoreExtension::getAttribute($this->env, $this->source, $context["reward"], "order_id", [], "any", false, false, false, 46)) {
                    // line 47
                    yield "\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
                    yield CoreExtension::getAttribute($this->env, $this->source, $context["reward"], "href", [], "any", false, false, false, 47);
                    yield "\">";
                    yield CoreExtension::getAttribute($this->env, $this->source, $context["reward"], "description", [], "any", false, false, false, 47);
                    yield "</a>
\t\t\t\t\t\t\t\t\t\t\t\t";
                } else {
                    // line 49
                    yield "\t\t\t\t\t\t\t\t\t\t\t\t\t";
                    yield CoreExtension::getAttribute($this->env, $this->source, $context["reward"], "description", [], "any", false, false, false, 49);
                    yield "
\t\t\t\t\t\t\t\t\t\t\t\t";
                }
                // line 51
...
\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-end\">";
                // line 52
                yield CoreExtension::getAttribute($this->env, $this->source, $context["reward"], "points", [], "any", false, false, false, 52);
                yield "</td>
\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t";
            }
...
";
    ...
    {
        return array (  224 => 85,  218 => 82,  214 => 80,  205 => 73,  201 => 72,  194 => 68,  190 => 67,  183 => 62,  176 => 58,  172 => 56,  169 => 55,  160 => 52,  157 => 51,  151 => 49,  143 => 47,  141 => 46,  136 => 44,  133 => 43,  128 => 42,  126 => 41,  119 => 37,  115 => 36,  111 => 35,  103 => 29,  96 => 24,  92 => 23,  87 => 21,  84 => 20,  77 => 15,  71 => 12,  66 => 9,  55 => 6,  52 => 5,  48 => 4,  42 => 1,);
    }
...
{{ footer }}
", "catalog/view/template/account/reward.twig", "C:\\xampp\\htdocs\\bareeq_platform\\catalog\\view\\template\\account\\reward.twig");
    }
}
