...
class __TwigTemplate_81d59deced087d193bb0cecfb02849be extends Template
{
        ...
        if (($context["apis"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["api"]) {
              ...
              <td class=\"text-end text-nowrap\"><a href=\"";
                ...
                yield "\" class=\"";
                if ( !CoreExtension::getAttribute($this->env, $this->source, $context["api"], "status", [], "any", false, false, false, 21)) {
...
";
    ...
    {
        return array (  164 => 34,  160 => 33,  154 => 29,  148 => 26,  145 => 25,  142 => 24,  125 => 21,  121 => 20,  117 => 19,  113 => 18,  109 => 17,  102 => 16,  97 => 15,  95 => 14,  88 => 10,  76 => 9,  64 => 8,  52 => 7,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("<form id=\"form-api\" method=\"post\" data-oc-toggle=\"ajax\" data-oc-load=\"{{ action }}\" data-oc-target=\"#list\">
  <div class=\"table-responsive\">
    <table class=\"table table-bordered table-hover\">
      <thead>
        <tr>
        ...
        {% if apis %}
          {% for api in apis %}
            <tr{% if not api.status %} class=\"table-disabled\"{% endif %}>
              ...
              <td class=\"text-end text-nowrap\"><a href=\"{{ api.edit }}\" data-bs-toggle=\"tooltip\" title=\"{{ button_edit }}\" class=\"{% if not api.status %}btn btn-secondary{% else %}btn btn-primary{% endif %}\"><i class=\"fa-solid fa-pencil\"></i></a></td>
            </tr>
          {% endfor %}
        {% else %}
          <tr>
...
", "admin/view/template/user/api_list.twig", "C:\\xampp\\htdocs\\bareeq_platform\\admin\\view\\template\\user\\api_list.twig");
    }
}
