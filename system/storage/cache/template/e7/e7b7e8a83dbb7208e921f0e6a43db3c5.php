...
class __TwigTemplate_efeffc5a4feb9f53eda151cffe60228b extends Template
{
  ...
  <div class=\"page-header\">
    <div class=\"container-fluid\">
      <div class=\"float-end\">
        ...
        <button type=\"submit\" data-oc-toggle=\"ajax\" form=\"form-order\" formaction=\"";
        // line 10
    ...
    <div class=\"row\">
      <div id=\"filter-order\" class=\"col-lg-3 col-md-12 order-lg-last d-none d-lg-block mb-3\">
        ...
        yield "\" id=\"input-date-to\" class=\"form-control\"/>
              ...
              <div class=\"mb-3\">
                <label for=\"input-date-modified-from\" class=\"form-label\">";
        // line 68
        yield ($context["entry_date_modified_from"] ?? null);
        yield "</label>
                <input type=\"date\" name=\"filter_date_modified_from\" value=\"";
        // line 69
        yield ($context["filter_date_modified_from"] ?? null);
        yield "\" placeholder=\"";
        yield ($context["entry_date_modified_from"] ?? null);
        yield "\" id=\"input-date-modified-from\" class=\"form-control\"/>
              </div>
              <div class=\"mb-3\">
                <label for=\"input-date-modified-to\" class=\"form-label\">";
        // line 72
        yield ($context["entry_date_modified_to"] ?? null);
        yield "</label>
                <input type=\"date\" name=\"filter_date_modified_to\" value=\"";
        // line 73
        yield ($context["filter_date_modified_to"] ?? null);
        yield "\" placeholder=\"";
        yield ($context["entry_date_modified_to"] ?? null);
        yield "\" id=\"input-date-modified-to\" class=\"form-control\"/>
              </div>
              <div class=\"text-end\">
...
\$('#form-filter').on('submit', function(e) {
    ...
    \$('#list').load('index.php?route=sale/order.list&user_token=";
        // line 106
        yield ($context["user_token"] ?? null);
        yield "&' + url);
});
...
";
    ...
    {
        return array (  364 => 148,  325 => 112,  316 => 106,  311 => 104,  290 => 86,  286 => 85,  275 => 77,  271 => 76,  263 => 73,  259 => 72,  251 => 69,  247 => 68,  239 => 65,  235 => 64,  227 => 61,  223 => 60,  215 => 57,  211 => 56,  206 => 53,  191 => 51,  187 => 50,  179 => 49,  173 => 46,  168 => 43,  153 => 41,  149 => 40,  143 => 37,  134 => 33,  130 => 32,  122 => 29,  118 => 28,  111 => 24,  102 => 17,  91 => 15,  87 => 14,  82 => 12,  73 => 10,  67 => 9,  61 => 8,  55 => 7,  51 => 6,  42 => 1,);
    }
...
//--></script>
{{ footer }}
", "admin/view/template/sale/order.twig", "C:\\xampp\\htdocs\\bareeq_platform\\admin\\view\\template\\sale\\order.twig");
    }
}
